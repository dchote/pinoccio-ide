 ...
 */
public class EditorToolbarOld extends JComponent implements MouseInputListener, KeyListener {
  ...
  public EditorToolbarOld(Editor editor, JMenu menu) {
    this.editor = editor;
    this.menu = menu;
  ...
  public void paintComponent(Graphics screen) {
    ...
    if ((offscreen == null) ||
      ...
      x1[SERIAL] = width - BUTTON_WIDTH - 7;
      x2[SERIAL] = width - 7;
    }
...
//
    case OPEN:
      ...
      popup.show(EditorToolbarOld.this, x, y);
      break;
